...
window.mobileCheck = function() {
  ...
  return check;
        ...
        function split_init() {
          document.cookie="testid="+testid;
            ...
            if (pageData != ''){ //user already visited
             ...
             if (number == 1){
              ...
              styles.media = 'screen';
              styles.href = 'components/assets/css/style.css';
              ...
              styles2.media = 'screen';
              styles2.href = 'components/assets/css/style-sm.css';
              document.getElementsByTagName('head')[0].appendChild(styles2);
                 ...
                 styles.type = 'text/css';
                 styles.media = 'screen';
                 styles.href = 'components/assets/css/style-2.css';
                 document.getElementsByTagName('head')[0].appendChild(styles);
                 ...
                 styles2.type = 'text/css';
                 styles2.media = 'screen';
                 styles2.href = 'components/assets/css/style-sm-2.css';
                 document.getElementsByTagName('head')[0].appendChild(styles2);
             }
          ...
          function recordCheckout(testid){ //function to record checkout click
