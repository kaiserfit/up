  $(document).ready(function(){
    ...
    crossDomain: true,
    data: {'action': 'pLoad','fpage': 'newQuiz','tokenx': tokenx, 'source': 'google'},
    dataType: 'json',
...
sessionStorage.setItem( "cquiz", jsonStr );

 var quizans = sessionStorage.getItem( "cquiz" );
 
 var quizobj = JSON.parse( quizans );

 document.cookie = "cquiz="+quizans;
  ...
  // console.log($.type(lazyloadImages));
